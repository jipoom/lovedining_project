...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'http://'.$_SERVER['HTTP_HOST'] .'/lovedining_project/public/images/user'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] .'/lovedining_project/public/images/user'; // Physical path. [Usually works fine like this]
	//$config['upload_path'] = 'C:/xampp/htdocs/tinymce_4'. $config['img_path'];
