...
@section('content')
<?php ob_start(); ?>
<div class="" style="border-style: ridge; border-width: 5px; border-color: #C0C0C0; margin: auto; background-color: #eeeeff;" align="center;">
<img src="{{{ asset('assets/img/logo.png') }}}" alt="Logo"  height="150" class ="logo">
